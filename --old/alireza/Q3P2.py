...
if __name__ == '__main__':
    ...
    txid_to_spend = ('b5029f1b5b52233bccf357ce69a66ed15ea0a64e296e8a1eb2a93a74e289266c') # TxHash of UTXO
    ...
    response = make_transaction(amount_to_send, txid_to_spend, utxo_index, txout_scriptPubKey, prime_num1_bytes, prime_num2_bytes, sum_bytes, sub_bytes)
