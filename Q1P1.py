...
def make_1to2_transaction(
    amount_to_send_1,
    amount_to_send_2,
    txid_to_spend,
    utxo_index,
    txout_scriptPubKey_1,
    txout_scriptPubKey_2,
):
    ...
    txin_scriptSig = P2PKH_scriptSig_2output(
        txin, txout1, txout2, txin_scriptPubKey, my_private_key, my_public_key
    )

    new_tx = create_1to2_signed_transaction(
        txin, txout1, txout2, txin_scriptPubKey, txin_scriptSig
    )
...
if __name__ == "__main__":
    ...
    response = make_1to2_transaction(
        amount_to_send_1,
        amount_to_send_2,
        txid_to_spend,
        utxo_index,
        txout_not_usable_scriptPubKey,
        txout_free_scriptPubKey,
    )
